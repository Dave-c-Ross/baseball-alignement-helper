...
class BBAHTeam {
	...
	createNewGame(date, gameID, gameNumber, myTeamName, opponentTeamName, isLocal, division, classe, league, availablePlayersIDs) {
		...
		game.teamName = myTeamName;
		game.opponentName = opponentTeamName;
		game.division = division;
		game.classe = classe;
		game.league = league;

		game.players = availablePlayersIDs;
